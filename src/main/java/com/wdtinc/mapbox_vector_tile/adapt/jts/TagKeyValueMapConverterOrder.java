 ...
 * @see ITagConverter
 */
public final class TagKeyValueMapConverterOrder implements ITagConverter {
     ...
     */
    public TagKeyValueMapConverterOrder() {
        this(false);
    }
     ...
     */
    public TagKeyValueMapConverterOrder(boolean nullIfEmpty) {
     ...
     */
    public TagKeyValueMapConverterOrder(boolean nullIfEmpty, String idKey) {
